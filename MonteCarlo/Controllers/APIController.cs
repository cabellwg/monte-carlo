...
namespace MonteCarlo.Controllers
{
    ...
    public class APIController : Controller
    {
        ...
        public JsonResult Get()
        {
            /* **********************************************************************
             *                                                                      *
             *          Change parameters for the in-browser tables below           *
             *                                                                      *
             *                                                                      *
             *                                                                      *
             *                                                                      *
            ...
            // Stocks
            var stocksMC = new StocksSimulation();
            ...
            // Bonds
            var bondsMC = new BondsSimulation();
            ...
            // Savings
            var savingsMC = new SavingsSimulation();
        ...
        public JsonResult GetHistorical()
        {
            ...
            //// Historical
            //var historicalMC = new StocksSimulation();
